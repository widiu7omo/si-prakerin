	...
	<div class="modal-dialog modal-dialog-centered modal-secondary" role="document">
		<div class="modal-content">
					...
					<ul class="list-group">
						...
						<li class="list-group-item p-1 pl-3">
							...
							<div id="komponen-penilaian" class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<a href="javascript:void(0)" class="btn btn-primary" id="edit-p1">Edit</a>
									</div>
							...
							<div id="komponen-penilaian" class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<a href="javascript:void(0)" class="btn btn-primary" id="edit-p2">Edit</a>
									</div>
							...
							<div id="komponen-penilaian" class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<a href="javascript:void(0)" class="btn btn-primary" id="edit-p3">Edit</a>
									</div>
							...
							<div id="komponen-penilaian" class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<a href="javascript:void(0)" class="btn btn-primary" id="edit-p4">Edit</a>
									</div>
							...
							<div id="komponen-penilaian" class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<a href="javascript:void(0)" class="btn btn-primary" id="edit-p5">Edit</a>
									</div>
			...
			<div class="modal-footer mt-2 pt-0">
				...
				<button type="button" class="btn btn-success btn-sm" id="btn-simpan-nilai" data-method="u">Simpan</button>
			</div>
		</div>
	</div>
</div>
