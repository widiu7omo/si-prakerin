<head>
	...
	<title>Prakerin
		| <?php echo ucfirst($this->uri->segment(1)) . " - " . (isset($_GET['m']) ? $_GET['m'] : null); ?></title>
	<!-- Favicon -->
	...
	<!-- Optional CSS -->
	<link rel="stylesheet"
		  href="<?php echo base_url('aset/vendor/datatables.net-bs4/css/dataTables.bootstrap4.min.css') ?>">
	<link rel="stylesheet" href="<?php echo base_url('aset/vendor/datatables.net/css/scroller.bootstrap4.min.css') ?>">
	<link rel="stylesheet"
		  href="<?php echo base_url('aset/vendor/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css') ?>">
	<link rel="stylesheet"
		  href="<?php echo base_url('aset/vendor/datatables.net-select-bs4/css/select.bootstrap4.min.css') ?>">
