			...
			<div class="col" id="mainbody">
				<?php if ($this->session->flashdata('success')): ?>
					<div class="alert alert-success alert-dismissible fade show" role="alert">
						...
						<small class="alert-text">Data Mahasiswa
							sebanyak <?php echo $this->session->flashdata('status')->tb_peserta ?></small><br>
						<small class="alert-text">Akun
							sebanyak <?php echo $this->session->flashdata('status')->tb_akun ?> telah terbuat</small>
				...
				<div class="card mb-5">
					<div class="card-header">
						<h3>Import Data Peserta Seminar</h3>
					</div>
					<div class="card-body">
														...
														<div class="form-group">
															...
															<select class="form-control" id="program-studi"
																...
																<?php foreach ($prodies as $prodi): ?>
																	<option
																		value="<?php echo $prodi->id_program_studi ?>">
																		<?php echo $prodi->nama_program_studi ?></option>
																<?php endforeach; ?>
															</select>
															<input type="hidden" name="tahunakademik"
																   value="<?php echo $currentTahun[0]->id_tahun_akademik ?>">
														</div>
													</div>
													<div class="col-6">
														<label for="">Contoh Format File Excel</label>
														<img src="<?php echo base_url('file_upload/sample.png') ?>" alt="Sample">
													</div>
												</div>
												...
												<div class="form-group sheet-form-name" style="display:none">
													<div class="row">
														...
														<div class="col-md-7 col-sm-7 col-lg-7 mt-4">
															...
															<small>* Data dimulai pada baris 4A</small>
															<br>
...
<script>
			...
			$('#sheet-name').on('change', (e) => {
				...
				if (e.target.value !== '') {
					...
					filteredData = dataFilter.map(function (object) {
						return {"nimpes": object.nimpes, "namapes": toTitleCase(object.namapes)}
					})
	...
	function retriveColumn(sheetName) {
		...
		var selectedColumn = []
		var patternHeaders = ['nimpes', 'namapes']
		var listHeaders = [];
		var newObj = {}
