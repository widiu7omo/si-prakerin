				...
				<div class="card">
					...
					<div class="card-header">
						<div class="row align-items-center">
							<div class="col-4">
								<h3 class="mb-0">Mahasiswa Belum Lulus PKL</h3>
								<p class="text-sm mb-0">
									Berikut daftar mahasiswa belum lulus PKL
								</p>
							</div>
                            <div class = "col-8">
                                <p class="text-sm mb-0">
                                ...
                                <?php foreach ($ta as $tahun): ?>
                                 <a href="<?php echo site_url("rekap?m=belum_lulus&filta=$tahun->id_tahun_akademik") ?>" class="btn btn-primary btn-sm <?php echo (isset($_GET['filta']) && $_GET['filta']== $tahun->id_tahun_akademik) ? 'active' : null ?>"> <?php echo "$tahun->tahun_akademik" ?></a>
                                 <?php endforeach ?>
                            </div>
						</div>
					</div>
					...
					<div class="table-responsive py-4">
						<table class="table table-flush" id="datatable-magang">
							...
							<tbody>
							<?php foreach ($mahbelumselesai as $key => $ms): ?>
