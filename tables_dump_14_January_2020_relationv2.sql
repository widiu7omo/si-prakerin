...
--
-- Database: sim_old
-- Generation Time: 2020-01-14 09:20:54.5940
-- -------------------------------------------------------------
...
CREATE TABLE `tb_dosen` (
  ...
  KEY `id_program_studi` (`id_program_studi`),
  CONSTRAINT `fk_dosen_pegawai` FOREIGN KEY (`nip_nik`) REFERENCES `tb_pegawai` (`nip_nik`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_dosen_ibfk_1` FOREIGN KEY (`id_program_studi`) REFERENCES `tb_program_studi` (`id_program_studi`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_dosen_bimbingan_mhs` (
  ...
  KEY `nip_nik` (`nip_nik`),
  KEY `id_mhs_pilih_perusahaan` (`id_mhs_pilih_perusahaan`),
  ...
  CONSTRAINT `tb_dosen_bimbingan_mhs_ibfk_3` FOREIGN KEY (`nip_nik`) REFERENCES `tb_pegawai` (`nip_nik`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_dosen_bimbingan_mhs_ibfk_4` FOREIGN KEY (`id_mhs_pilih_perusahaan`) REFERENCES `tb_mhs_pilih_perusahaan` (`id_mhs_pilih_perusahaan`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_golongan` (
  ...
  UNIQUE KEY `id` (`id_golongan`) USING BTREE
...
CREATE TABLE `tb_history_judul` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`),
  CONSTRAINT `tb_history_judul_ibfk_1` FOREIGN KEY (`id_dosen_bimbingan_mhs`) REFERENCES `tb_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_history_pemilihan` (
  ...
  `nim` varchar(10) DEFAULT NULL,
  `nomor_surat` mediumtext DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_perusahaan` (`id_perusahaan`),
  KEY `nim` (`nim`),
  CONSTRAINT `tb_history_pemilihan_ibfk_1` FOREIGN KEY (`id_perusahaan`) REFERENCES `tb_perusahaan` (`id_perusahaan`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_history_pemilihan_ibfk_2` FOREIGN KEY (`nim`) REFERENCES `tb_mahasiswa` (`nim`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_history_seminar_penilaian` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id_seminar_penilaian` (`id_seminar_penilaian`),
  CONSTRAINT `tb_history_seminar_penilaian_ibfk_1` FOREIGN KEY (`id_seminar_penilaian`) REFERENCES `tb_seminar_penilaian` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_kelengkapan_berkas` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`),
  CONSTRAINT `tb_kelengkapan_berkas_ibfk_1` FOREIGN KEY (`id_dosen_bimbingan_mhs`) REFERENCES `tb_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_konsultasi_bimbingan_offline` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`),
  CONSTRAINT `tb_konsultasi_bimbingan_offline_ibfk_1` FOREIGN KEY (`id_dosen_bimbingan_mhs`) REFERENCES `tb_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_mhs_pilih_perusahaan` (
  ...
  `id_perusahaan` int(11) DEFAULT NULL,
  `nim` varchar(10) DEFAULT NULL,
  `nomor_surat_tugas` mediumtext DEFAULT NULL,
...
CREATE TABLE `tb_nilai_akhir` (
  ...
  KEY `id_seminar_penilaian` (`id_seminar_penilaian`),
  KEY `id_perusahaan_penilaian` (`id_perusahaan_penilaian`),
  CONSTRAINT `tb_nilai_akhir_ibfk_1` FOREIGN KEY (`id_seminar_penilaian`) REFERENCES `tb_seminar_penilaian` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_nilai_akhir_ibfk_2` FOREIGN KEY (`id_perusahaan_penilaian`) REFERENCES `tb_perusahaan_penilaian` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `tb_pegawai` (
  ...
  KEY `fk_pegawai_jabatan` (`id_jabatan`) USING BTREE,
  KEY `fk_pegawai_golongan` (`id_golongan`) USING BTREE,
...
CREATE TABLE `tb_perusahaan_penilaian` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`),
  CONSTRAINT `tb_perusahaan_penilaian_ibfk_1` FOREIGN KEY (`id_dosen_bimbingan_mhs`) REFERENCES `tb_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_perusahaan_sementara` (
  ...
  CONSTRAINT `tb_perusahaan_sementara_ibfk_1` FOREIGN KEY (`nim`) REFERENCES `tb_mahasiswa` (`nim`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_seminar_jadwal` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`),
  KEY `id_seminar_ruangan` (`id_seminar_ruangan`),
  KEY `id_penguji_1` (`id_penguji_1`),
  KEY `id_penguji_2` (`id_penguji_2`),
  CONSTRAINT `tb_seminar_jadwal_ibfk_1` FOREIGN KEY (`id_dosen_bimbingan_mhs`) REFERENCES `tb_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_seminar_jadwal_ibfk_3` FOREIGN KEY (`id_seminar_ruangan`) REFERENCES `tb_seminar_tempat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_seminar_jadwal_ibfk_5` FOREIGN KEY (`id_penguji_1`) REFERENCES `tb_seminar_penguji` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_seminar_jadwal_ibfk_6` FOREIGN KEY (`id_penguji_2`) REFERENCES `tb_seminar_penguji` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tb_seminar_penguji` (
  ...
  CONSTRAINT `tb_seminar_penguji_ibfk_1` FOREIGN KEY (`id_dosen`) REFERENCES `tb_dosen` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=267 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `tb_seminar_penilaian` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id_seminar_jadwal` (`id_seminar_jadwal`),
  KEY `id_dosen` (`id_dosen`),
  CONSTRAINT `tb_seminar_penilaian_ibfk_1` FOREIGN KEY (`id_seminar_jadwal`) REFERENCES `tb_seminar_penilaian` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_seminar_penilaian_ibfk_2` FOREIGN KEY (`id_dosen`) REFERENCES `tb_dosen` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tabel_berita` (`id_berita`, `nama_berita`, `slug_berita`, `konten_berita`, `tanggal_berita`, `gambar_berita`, `id_berita_view`, `status_berita`) VALUES ('1', 'Peluncuran Sistem Informasi Praktek Kerja Industri', 'peluncuran-sistem-informasi-praktek-kerja-industri', '<p><strong>PRAKERIN Politeknik Negeri Tanah Laut -</strong>&nbsp;Segera meluncurkan sebuah sistem informasi yang&nbsp; Praktek Kerja Industri diantaranya yaitu:</p>\r\n\r\n<ol style=\"list-style-type:decimal; margin-left:20px; margin-right:20\">\r\n	<li>Sistem Informasi Managemen Praktek Kerja Industri (SIM-Prakerin)</li>\r\n	<li>Sistem Informasi Geografis Tempat Praktek Kerja Industri (SIG-Prakerin)</li>\r\n	<li>Sistem Informasi Monitoring Praktek Kerja Industri (SIMONEP)</li>\r\n</ol>\r\n', '2019-07-30', '1564474361Peluncuran_Sistem_Informasi_Praktek_Kerja_Industri.jpg', '0', '');

INSERT INTO `tabel_file` (`id_file`, `nama_file`, `tanggal_file`, `data_file`, `status_file`) VALUES ('3', 'Persentasi Buku PKl versi 3', '2019-09-08', '1567951981Persentasi_Buku_PKl_versi_3.pptx', X'54616d70696c'),
('4', '1. KUMPULAN LAMPIRAN-LAMPIRAN BERKAS PKL', '2019-09-09', '15679944611__KUMPULAN_LAMPIRAN-LAMPIRAN_BERKAS_PKL.docx', X'54616d70696c'),
('5', '2. BIODATA PEMBIMBING DI KAMPUS', '2019-09-09', '15679944952__BIODATA_PEMBIMBING_DI_KAMPUS.docx', X'54616d70696c'),
('6', '3. FORM DATA PERUSAHAAN', '2019-09-09', '15679945343__FORM_DATA_PERUSAHAAN.docx', X'54616d70696c'),
('7', '4. PENILAIAN PRAKTEK KERJA LAPANGAN (pembimbing lapangan)', '2019-09-09', '15679945564__PENILAIAN_PRAKTEK_KERJA_LAPANGAN_(pembimbing_lapangan).docx', X'54616d70696c'),
('8', '5. PRESENSI KEHADIRAN PRAKTEK KERJA LAPANGAN', '2019-09-09', '15679945775__PRESENSI_KEHADIRAN_PRAKTEK_KERJA_LAPANGAN.docx', X'54616d70696c'),
('9', '6. LEMBAR PERSETUJUAN TELAH MENYELESAIKAN REVISI', '2019-09-09', '15679946166__LEMBAR_PERSETUJUAN_TELAH_MENYELESAIKAN_REVISI.docx', X'54616d70696c'),
('10', '7. Contoh _SERTIFIKAT PKL', '2019-09-09', '15679946367__Contoh__SERTIFIKAT_PKL.docx', X'54616d70696c'),
('11', '9. Template PKL Politala 2019 Rev.5', '2019-09-09', '15679953549__Template_PKL_Politala_2019_Rev_5.docx', X'54616d70696c'),
('12', 'Buku PKL', '2019-09-13', '1568305153Buku_PKL.pdf', X'54616d70696c');

INSERT INTO `tabel_foto` (`id_foto`, `nama_foto`, `deskripsi_foto`, `tanggal_foto`, `data_foto`, `kategori_foto`) VALUES ('2', '', '', '2019-07-30', '1564474375.jpg', X'736c69646573686f7773'),
('4', 'Monitoring PKL ke PLTD Pagatan Tanah Bumbu', '-', '2019-07-30', '1564472243_Mentoring_ke_Perusahaan.jpg', X'67616c657269'),
('5', 'Monitoring PKL ke Perusahaan Kelapa Sawit Kotabaru', '-', '2019-07-30', '1564472259_Mentoring_ke_Perusahaan.jpg', X'67616c657269'),
('6', 'Monitoring PKL ke PT. Batu Bulan Mill Tanah Bumbu', '-', '2019-07-30', '1564472270_Mentoring_ke_Perusahaan.jpg', X'67616c657269'),
('7', 'Monitoring PKL ke PT. Balengkong Sebuku', '-', '2019-07-30', '1564473101_Monitoring_PKL_ke_PT__Balengkong_Sebuku.jpg', X'67616c657269'),
('8', 'Monitoring PKL ke PT. JBG Jorong', '-', '2019-07-30', '1564473150_Monitoring_PKL_ke_PT__JBG_Jorong.jpg', X'67616c657269'),
('9', 'Monitoring PKL ke PT. PLTA Riam Kanan', '-', '2019-07-30', '1564473239_Monitoring_PKL_ke_PT__PLTA_Riam_Kanan.jpg', X'67616c657269'),
('10', 'Monitoring PKL ke PT. Phinemo Kreasi Media Semarang Jawa Tengah', '-', '2019-07-30', '1564473298_Monitoring_PKL_ke_PT__Phinemo_Kreasi_Media_Semarang_Jawa_Tengah.jpg', X'67616c657269'),
('11', 'Monitoring PKL ke PT. Amanah Anugerah Adi Mulia Banjarmasin', '-', '2019-07-30', '1564473587_Monitoring_PKL_ke_PT__Amanah_Anugerah_Adi_Mulia_Banjarmasin.jpeg', X'67616c657269'),
('12', 'Monitoring PKL ke PT. Diginet Media Yogyakarta', '-', '2019-07-30', '1564474992_Monitoring_PKL_ke_PT__Diginet_Media_Yogyakarta.jpg', X'67616c657269'),
('13', 'Monitoring PKL ke Perusahaan Software House Malang', '-', '2019-07-30', '1564475106_Monitoring_PKL_ke_Perusahaan_Software_House_Malang.jpg', X'67616c657269'),
('14', 'Monitoring PKL ke PLN AP2B Banjarbaru', '-', '2019-07-30', '1564475171_Monitoring_PKL_ke_PLN_AP2B_Banjarbaru.jpg', X'67616c657269'),
('15', 'Monitoring PKL ke PT. Smart Tarjun Kotabaru', '-', '2019-07-30', '1564475264_Monitoring_PKL_ke_PT__Smart_Tarjun_Kotabaru.jpg', X'67616c657269'),
('16', 'Monitoring PKL ke PT. Angkasa Pura I', '-', '2019-07-30', '1564475336_Monitoring_PKL_ke_PT__Angkasa_Pura_I.jpg', X'67616c657269'),
('17', '', '', '2019-11-26', '1574753834.jpg', X'736c69646573686f7773');
...
INSERT INTO `tb_akun` (`username`, `password`, `created_at`, `updated_at`, `id`) VALUES ('A1317001', '$2y$10$jNnOnmv7fUpv80CRvVn7c.kwAas/stx38DBTNaszjKYtvFWcvb6X6', '2020-01-02 09:37:47', NULL, '452'),
('A1317002', '$2y$10$2HrKUZaoEKwraLi/caMcZO/sjystSbobqZlbOB3ik3Yq0bvj7bN8S', '2020-01-02 09:37:47', NULL, '476'),
('A1317003', '$2y$10$YyxG.AqITP5qV0b.UHkFJeaBll8aE/uxHQey4fmWhxv0.6OT3zd06', '2020-01-02 09:37:47', NULL, '518'),
('A1317004', '$2y$10$KfOxumdVRCDp.0yL5aP8W.oHyoXHdApjNVHcgtCHXZbUOYWpMXTiq', '2020-01-02 09:37:47', NULL, '478'),
('A1317005', '$2y$10$UFJ5xZ7srxd1JgyJ5CpGK.BthBWDZ4FEHYM98HvSFe3KXXBW8kc4a', '2020-01-02 09:37:47', NULL, '517'),
('A1317006', '$2y$10$i9mAP3z/STFw5UOPNOCF5.MFWrevFYeryXNwg9cUoJ.Eu4f2XlyGS', '2020-01-02 09:37:47', NULL, '504'),
('A1317008', '$2y$10$8BeTdO0DHsg3vxW/ssfYp.vq0IfJSI.koP5C3mGlwAdbb3uSg46Ke', '2020-01-02 09:37:47', NULL, '487'),
('A1317009', '$2y$10$SvwSp2wA66zCiwGG/6b4he5E1Mp38hmiUP82IcOMrVsbzpQL5/VAa', '2020-01-02 09:37:47', NULL, '458'),
('A1317010', '$2y$10$Z5pIEHO2I0.iB2uzbKoXjOpRJU/nzfeBYOPjBF8Q2eWEvrkfkfh5a', '2020-01-02 09:37:47', NULL, '500'),
('A1317011', '$2y$10$Irn/md2ELsI8S9MbFNVbT.s741SWCag2cbrqjawpLf.zKIncFEllq', '2020-01-02 09:37:47', NULL, '528'),
('A1317012', '$2y$10$oRnyMNC3bHGmw4Om9KoFLuCMSUvqPQQS3ZVTBFSahfVaDle1fK2ya', '2020-01-02 09:37:47', NULL, '498'),
('A1317013', '$2y$10$flCr6BTgcyLU.kunO7vvreyfvJpTfRc8ryZ59/2KVt8NiaM8YaUy.', '2020-01-02 09:37:47', NULL, '507'),
('A1317014', '$2y$10$dUy8EliH9wnLwyw3jAweIOs2nrR.tLfXk2B/IT4i8QFxNG6ih.rYS', '2020-01-02 09:37:47', NULL, '505'),
politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '436'),
('agustiannoor@politala.ac.id', '9cf43feb3f23edf49ea3eb4c407f7853', '2020-01-02 08:58:26', NULL, '431'),
('angkasa@politala.ac.id', '65abcdaa9d838672864004bcc85bdd3b', '2020-01-02 08:58:26', NULL, '407'),
('arif@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '405'),
('dosendua@politala.ac.id', '4297f44b13955235245b2497399d7a93', '2020-01-08 15:13:54', NULL, '530'),
('dosen_satu@politala.ac.id', '202cb962ac59075b964b07152d234b70', '2020-01-02 09:57:08', NULL, '529'),
('emalestari@politala.ac.id', '9c468e729ef3b158201b1217eeb1f1c6', '2020-01-02 08:58:26', NULL, '430'),
('fathurrahmani@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '420'),
('fatimah@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '439'),
('hafizd@politala.ac.id', '343fd51a3cadffd16fafa0b6b5f3b30b', '2020-01-02 08:58:26', NULL, '427'),
('hendrik.tomo@politala.ac.id', '258b0b133466092ff4405e75aa212198', '2020-01-02 08:58:26', NULL, '415'),
('herfia.rhomadhona@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '402'),
('herpendi@politala.ac.id', '4297f44b13955235245b2497399d7a93', '2020-01-13 17:10:44', NULL, '429'),
('ika.kusuma.n@politala.ac.id', 'f652b3d67b407ddd9527b49593ecd616', '2020-01-02 08:58:26', NULL, '408'),
('imron@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '426'),
('jakapermadi.88@politala.ac.id', 'eeddfce33f1cae7437cacb6aa3ed5180', '2020-01-02 08:58:26', NULL, '432'),
('jaka_dj@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '440'),
('jefriadi@politala.ac.id', 'aa746269343f2b66a56fa0705c4c9c6d', '2020-01-02 08:58:26', NULL, '433'),
('kurnia.2a@politala.ac.id', '835afaa2dae3b4a26045b8153b6650ce', '2020-01-02 08:58:26', NULL, '412'),
('kuswoyoanton@politala.ac.id', 'd70758563d6e8c104a20c7c98d3a4192', '2020-01-02 08:58:26', NULL, '418'),
('mariatul@politala.ac.id', 'a0491fe48eef3b72d15a05e69b4e93c9', '2020-01-02 08:58:26', NULL, '434'),
('marlia@politala.ac.id', 'b49a2da6055b4c32902942c80708c062', '2020-01-02 08:58:26', NULL, '401'),
('meldayanoor@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '438'),
('mindradarmawan@politala.ac.id', '0149d1fb991126227beb2d83d04f3b6c', '2020-01-02 08:58:26', NULL, '435'),
('mufrida@politala.ac.id', 'cb88cbc22d48cb72861bd85b3fc4865a', '2020-01-02 08:58:26', NULL, '437'),
('muhammadnoor@politala.ac.id', 'caacbb06ae82a7a8a1ae114cf58af205', '2020-01-02 08:58:26', NULL, '425'),
('ninahairiyah@politala.ac.id', '9af7ddec5ede8d9d4fff7b253b2499bc', '2020-01-02 08:58:26', NULL, '411'),
('nuryati@politala.ac.id', 'e91bd884adde9b8c04357b8e2a412286', '2020-01-02 08:58:26', NULL, '419'),
('ra.amalia.rizki@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '404'),
('radna@politala.ac.id', 'ab24e24ea962aa0e02e076294ed71998', '2020-01-02 08:58:26', NULL, '406'),
('redhy@politala.ac.id', '827ccb0eea8a706c4c34a16891f84e7b', '2020-01-02 08:58:26', NULL, '413'),
('reza@politala.ac.id', '403a6f197124456fa304e8a75e514aa4', '2020-01-02 08:58:26', NULL, '421'),
('rsayyidati@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '424'),
('rusumintosyahyuniar@politala.ac.id', '5dd2f3dda7890376cfb20c7e9f4af872', '2020-01-02 08:58:26', NULL, '417'),
('sandri@politala.ac.id', '358dd7dfbb9518bf775f1b3a30013bf5', '2020-01-02 08:58:26', NULL, '410'),
('simpkl@politala.ac.id', '4297f44b13955235245b2497399d7a93', '2020-01-02 09:20:49', NULL, '442'),
('sukma@politala.ac.id', '4bd8058a99522e09c4cf23370512e29c', '2020-01-02 08:58:26', NULL, '416'),
('veri@politala.ac.id', '9735f98f3cbd11ec1f1e5b57d106e462', '2020-01-02 08:58:26', NULL, '441'),
('wanyuliyanti@politala.ac.id', '55b7db95219ae4a23b1a098a0af22fbe', '2020-01-02 08:58:26', NULL, '403'),
('winda@politala.ac.id', '037245f05147c237529f12b08868ef88', '2020-01-02 08:58:26', NULL, '428'),
('wiwik.kusrini@politala.ac.id', '3d1cb141faa0ad04dcde64c9a1798f8c', '2020-01-02 08:58:26', NULL, '414'),
('yuliananingsih@politala.ac.id', '5ee6c077974421156c7f44b93e2c8fd8', '2020-01-02 08:58:26', NULL, '423'),
('yunitaprastya@politala.ac.id', 'b4d1801df7a2ce3e89d559b4aab45e38', '2020-01-02 08:58:26', NULL, '409');
...
INSERT INTO `tb_dosen` (`id`, `nip_nik`, `id_program_studi`) VALUES ('63', '199007112015041003', 'PST001'),
('64', '199007112015041004', 'PST001'),
('65', '160201151', 'PST001');

INSERT INTO `tb_history_pemilihan` (`id`, `id_perusahaan`, `nim`, `nomor_surat`) VALUES ('5', '54', 'A1317003', NULL),
('6', '55', 'A1317004', NULL);
...
INSERT INTO `tb_level` (`id_level`, `username`, `id_master_level`) VALUES ('3668', 'marlia@politala.ac.id', 'IML005'),
...
('3710', 'A1317040', 'IML006'),
('3711', 'A1317093', 'IML006'),
('3712', 'A1317079', 'IML006'),
('3713', 'A1317016', 'IML006'),
('3714', 'A1317109', 'IML006'),
('3715', 'A1317041', 'IML006'),
('3716', 'A1317065', 'IML006'),
('3717', 'A1317017', 'IML006'),
('3718', 'A1317022', 'IML006'),
('3719', 'A1317001', 'IML006'),
('3720', 'A1317077', 'IML006'),
('3721', 'A1317080', 'IML006'),
('3722', 'A1317035', 'IML006'),
('3723', 'A1317074', 'IML006'),
('3724', 'A1317076', 'IML006'),
('3725', 'A1317009', 'IML006'),
('3726', 'A1317055', 'IML006'),
('3727', 'A1317057', 'IML006'),
('3728', 'A1317027', 'IML006'),
('3729', 'A1317068', 'IML006'),
('3730', 'A1317042', 'IML006'),
('3731', 'A1317052', 'IML006'),
('3732', 'A1317067', 'IML006'),
('3733', 'A1317096', 'IML006'),
('3734', 'A1317101', 'IML006'),
('3735', 'A1317034', 'IML006'),
('3736', 'A1317088', 'IML006'),
('3737', 'A1317033', 'IML006'),
('3738', 'A1317054', 'IML006'),
('3739', 'A1317056', 'IML006'),
('3740', 'A1317048', 'IML006'),
('3741', 'A1317061', 'IML006'),
('3742', 'A1317086', 'IML006'),
('3743', 'A1317002', 'IML006'),
('3744', 'A1317078', 'IML006'),
('3745', 'A1317004', 'IML006'),
('3746', 'A1317018', 'IML006'),
('3747', 'A1317075', 'IML006'),
('3748', 'A1317030', 'IML006'),
('3749', 'A1317073', 'IML006'),
('3750', 'A1317058', 'IML006'),
('3751', 'A1317081', 'IML006'),
('3752', 'A1317037', 'IML006'),
('3753', 'A1317047', 'IML006'),
('3754', 'A1317008', 'IML006'),
('3755', 'A1317036', 'IML006'),
('3756', 'A1317087', 'IML006'),
('3757', 'A1317020', 'IML006'),
('3758', 'A1317071', 'IML006'),
('3759', 'A1317045', 'IML006'),
('3760', 'A1317066', 'IML006'),
('3761', 'A1317111', 'IML006'),
('3762', 'A1317094', 'IML006'),
('3763', 'A1317026', 'IML006'),
('3764', 'A1317104', 'IML006'),
('3765', 'A1317012', 'IML006'),
('3766', 'A1317044', 'IML006'),
('3767', 'A1317010', 'IML006'),
('3768', 'A1317106', 'IML006'),
('3769', 'A1317090', 'IML006'),
('3770', 'A1317092', 'IML006'),
('3771', 'A1317006', 'IML006'),
('3772', 'A1317014', 'IML006'),
('3773', 'A1317023', 'IML006'),
('3774', 'A1317013', 'IML006'),
('3775', 'A1317083', 'IML006'),
('3776', 'A1317051', 'IML006'),
('3777', 'A1317082', 'IML006'),
('3778', 'A1317060', 'IML006'),
('3779', 'A1317097', 'IML006'),
('3780', 'A1317050', 'IML006'),
('3781', 'A1317064', 'IML006'),
('3782', 'A1317025', 'IML006'),
('3783', 'A1317103', 'IML006'),
('3784', 'A1317005', 'IML006'),
('3785', 'A1317003', 'IML006'),
('3786', 'A1317031', 'IML006'),
('3787', 'A1317046', 'IML006'),
('3788', 'A1317098', 'IML006'),
('3789', 'A1317099', 'IML006'),
('3790', 'A1317100', 'IML006'),
('3791', 'A1317107', 'IML006'),
('3792', 'A1317108', 'IML006'),
('3793', 'A1317019', 'IML006'),
('3794', 'A1317021', 'IML006'),
('3795', 'A1317011', 'IML006'),
('3796', 'dosen_satu@politala.ac.id', 'IML005'),
('3797', 'dosendua@politala.ac.id', 'IML005');

INSERT INTO `tb_mahasiswa` (`nim`, `id_tahun_akademik`, `id_program_studi`, `username`, `nama_mahasiswa`, `alamat_mhs`, `jenis_kelamin_mhs`, `email_mhs`, `tempat_lahir_mhs`, `tanggal_lahir_mhs`, `no_hp_mahasiswa`, `nama_orangtua_mhs`, `no_hp_orangtua_mhs`) VALUES ('A1317001', 'TA002', 'PST001', 'A1317001', 'Achmad Syah Maulana', 'RT', 'Laki-laki', 'widiu7omo@gmail.com', 'Pelaihari', '2020-01-06', '+6282335463777', 'Huna', '+623346577382'),
('A1317002', 'TA002', 'PST001', 'A1317002', 'Ade Ardha Reswari', 'RT', 'Laki-laki', 'widiu7omo@gmail.com', 'Pelaihari', '1999-02-22', '+6282335463777', 'Huna', '+623346577382'),
('A1317003', 'TA002', 'PST001', 'A1317003', 'Adela Valiandra', 'RT', 'Laki-laki', 'widiu7omo@gmail.com', 'Pelaihari', '2020-06-09', '+6282335463777', 'Huna', '+623346577382'),
('A1317004', 'TA002', 'PST001', 'A1317004', 'Agi Munawa', 'RT', 'Laki-laki', 'widiu7omo@gmail.com', 'Pelaihari', '2020-01-14', '+6282335463777', 'Huna', '+623346577382'),
('A1317005', 'TA002', 'PST001', 'A1317005', 'Ahmad Asegaf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317006', 'TA002', 'PST001', 'A1317006', 'Ahmad Laily Misfi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317010', 'TA002', 'PST001', 'A1317010', 'Anita', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317023', 'TA002', 'PST001', 'A1317023', 'Fajar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317025', 'TA002', 'PST001', 'A1317025', 'Gusti Ahmad Hafi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317030', 'TA002', 'PST001', 'A1317030', 'Inka Nurjanah', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317031', 'TA002', 'PST001', 'A1317031', 'Istiqomah', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317037', 'TA002', 'PST001', 'A1317037', 'Lidya Novita', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317051', 'TA002', 'PST001', 'A1317051', 'Mila Camelia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317055', 'TA002', 'PST001', 'A1317055', 'Muhammad Rizky Ansyari', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317064', 'TA002', 'PST001', 'A1317064', 'Noor Latipah', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317065', 'TA002', 'PST001', 'A1317065', 'Nor Janah', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317066', 'TA002', 'PST001', 'A1317066', 'Norhatiah', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317077', 'TA002', 'PST001', 'A1317077', 'Restu Adji Saputra', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317078', 'TA002', 'PST001', 'A1317078', 'Retno Fratiwi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317079', 'TA002', 'PST001', 'A1317079', 'Reyfindy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317082', 'TA002', 'PST001', 'A1317082', 'Rini Yuliani', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317090', 'TA002', 'PST001', 'A1317090', 'Sinta Esti Rahayu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('A1317097', 'TA002', 'PST001', 'A1317097', 'Tsamara Dara Rizkita', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317098', 'TA002', 'PST001', 'A1317098', 'Wahzuni Sri Rahayu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317099', 'TA002', 'PST001', 'A1317099', 'Winda Dwi Sulistia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317100', 'TA002', 'PST001', 'A1317100', 'Yeremia Handoyo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317101', 'TA002', 'PST001', 'A1317101', 'Yeyen Nurul Imama', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317103', 'TA002', 'PST001', 'A1317103', 'Yougie Affandi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317104', 'TA002', 'PST001', 'A1317104', 'Yunita Anggraini', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('A1317106', 'TA002', 'PST001', 'A1317106', 'Fransisca Jeni Tari Krismany', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
INSERT INTO `tb_mhs_pilih_perusahaan` (`id_mhs_pilih_perusahaan`, `id_perusahaan`, `nim`, `nomor_surat_tugas`) VALUES ('21', '52', 'A1317002', NULL),
('22', '52', 'A1317003', NULL);

INSERT INTO `tb_negara` (`id_negara`, `nama_negara`) VALUES ('1', 'INDONESIA');

INSERT INTO `tb_notification` (`id`, `pengirim`, `penerima`, `pesan`, `status`, `waktu`, `hal`, `uri`) VALUES ('1', 'admin', 'A1317040', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('2', 'admin', 'A1317093', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('3', 'admin', 'A1317079', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('4', 'admin', 'A1317016', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('5', 'admin', 'A1317109', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('6', 'admin', 'A1317041', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('7', 'admin', 'A1317065', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('8', 'admin', 'A1317017', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('9', 'admin', 'A1317022', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('10', 'admin', 'A1317001', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '1', '2020-01-02 18:45:58', X'70726f66696c', 'user/profile'),
('11', 'admin', 'A1317077', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('12', 'admin', 'A1317080', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('13', 'admin', 'A1317035', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('14', 'admin', 'A1317074', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('15', 'admin', 'A1317076', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('16', 'admin', 'A1317009', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('17', 'admin', 'A1317055', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('18', 'admin', 'A1317057', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('19', 'admin', 'A1317027', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('20', 'admin', 'A1317068', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('21', 'admin', 'A1317042', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('22', 'admin', 'A1317052', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('23', 'admin', 'A1317067', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('24', 'admin', 'A1317096', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('25', 'admin', 'A1317101', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('26', 'admin', 'A1317034', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('27', 'admin', 'A1317088', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('28', 'admin', 'A1317033', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('29', 'admin', 'A1317054', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('30', 'admin', 'A1317056', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('31', 'admin', 'A1317048', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('32', 'admin', 'A1317061', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('33', 'admin', 'A1317086', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('34', 'admin', 'A1317002', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '1', '2020-01-02 09:38:17', X'70726f66696c', 'user/profile'),
('35', 'admin', 'A1317078', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('36', 'admin', 'A1317004', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '1', '2020-01-02 23:36:21', X'70726f66696c', 'user/profile'),
('37', 'admin', 'A1317018', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('38', 'admin', 'A1317075', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('39', 'admin', 'A1317030', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('40', 'admin', 'A1317073', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('41', 'admin', 'A1317058', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('42', 'admin', 'A1317081', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('43', 'admin', 'A1317037', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('44', 'admin', 'A1317047', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('45', 'admin', 'A1317008', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('46', 'admin', 'A1317036', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('47', 'admin', 'A1317087', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('48', 'admin', 'A1317020', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('49', 'admin', 'A1317071', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('50', 'admin', 'A1317045', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('51', 'admin', 'A1317066', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('52', 'admin', 'A1317111', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('53', 'admin', 'A1317094', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('54', 'admin', 'A1317026', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('55', 'admin', 'A1317104', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('56', 'admin', 'A1317012', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('57', 'admin', 'A1317044', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('58', 'admin', 'A1317010', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('59', 'admin', 'A1317106', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('60', 'admin', 'A1317090', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('61', 'admin', 'A1317092', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('62', 'admin', 'A1317006', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('63', 'admin', 'A1317014', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('64', 'admin', 'A1317023', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('65', 'admin', 'A1317013', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('66', 'admin', 'A1317083', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('67', 'admin', 'A1317051', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('68', 'admin', 'A1317082', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('69', 'admin', 'A1317060', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('70', 'admin', 'A1317097', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('71', 'admin', 'A1317050', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('72', 'admin', 'A1317064', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('73', 'admin', 'A1317025', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('74', 'admin', 'A1317103', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('75', 'admin', 'A1317005', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('76', 'admin', 'A1317003', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '1', '2020-01-02 19:52:10', X'70726f66696c', 'user/profile'),
('77', 'admin', 'A1317031', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('78', 'admin', 'A1317046', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('79', 'admin', 'A1317098', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('80', 'admin', 'A1317099', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('81', 'admin', 'A1317100', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('82', 'admin', 'A1317107', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('83', 'admin', 'A1317108', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('84', 'admin', 'A1317019', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('85', 'admin', 'A1317021', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('86', 'admin', 'A1317011', 'Silahkan melengkapi profil terlebih dahulu untuk bisa mengajukan permohonan magang', '0', '2020-01-02 09:37:47', X'70726f66696c', 'user/profile'),
('87', 'A1317002', 'admin', 'Ade Ardha Reswari (A1317002) mengajukan permohonan magang', '1', '2020-01-02 10:28:14', X'70656e67616a75616e206d6167616e67', 'mahasiswa?m=pengajuan'),
('88', 'admin', 'A1317002', 'Surat sudah ditandatangani, siap untuk dikirimkan', '1', '2020-01-02 10:22:12', X'73757261742073696170', 'magang?m=pengajuan'),
('89', 'A1317002', 'admin', 'Ade Ardha Reswari (A1317002) telah mengirim bukti penerimaan magang', '1', '2020-01-02 10:28:14', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('90', 'Prakerin', 'A1317002', 'Mohon untuk upload ulang bukti penerimaan magang, bukti yang di kirim tidak sesuai atau tidak bisa di baca', '1', '2020-01-02 10:22:12', X'55706c6f616420556c616e672042756b74692050656e657269', 'magang?m=pengajuan'),
('91', 'A1317002', 'admin', 'Ade Ardha Reswari (A1317002) telah mengirim bukti penerimaan magang', '1', '2020-01-02 10:28:14', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('92', 'admin', 'A1317002', 'Surat tugas sudah dicetak, silahkan hubungi prakerin untuk informasi selanjutnya', '1', '2020-01-02 10:22:12', X'73757261742074756761732073696170', NULL),
('93', 'A1317001', 'admin', 'Achmad Syah Maulana (A1317001) mengajukan permohonan magang', '1', '2020-01-06 14:49:20', X'70656e67616a75616e206d6167616e67', 'mahasiswa?m=pengajuan'),
('94', 'admin', 'A1317002', 'Surat tugas sudah dicetak, silahkan hubungi prakerin untuk informasi selanjutnya', '0', '2020-01-02 19:12:49', X'73757261742074756761732073696170', NULL),
('95', 'A1317003', 'admin', 'Adela Valiandra (A1317003) mengajukan permohonan magang', '1', '2020-01-06 14:49:20', X'70656e67616a75616e206d6167616e67', 'mahasiswa?m=pengajuan'),
('96', 'admin', 'A1317002', 'Surat tugas sudah dicetak, silahkan hubungi prakerin untuk informasi selanjutnya', '0', '2020-01-02 20:20:02', X'73757261742074756761732073696170', NULL),
('97', 'admin', 'A1317002', 'Surat tugas sudah dicetak, silahkan hubungi prakerin untuk informasi selanjutnya', '0', '2020-01-02 20:21:06', X'73757261742074756761732073696170', NULL),
('98', 'admin', 'A1317001', 'Surat sudah ditandatangani, siap untuk dikirimkan', '0', '2020-01-02 21:42:43', X'73757261742073696170', 'magang?m=pengajuan'),
('99', 'admin', 'A1317003', 'Surat sudah ditandatangani, siap untuk dikirimkan', '0', '2020-01-02 21:51:38', X'73757261742073696170', 'magang?m=pengajuan'),
('100', 'A1317003', 'admin', 'Adela Valiandra (A1317003) mengajukan permohonan magang', '1', '2020-01-06 14:49:20', X'70656e67616a75616e206d6167616e67', 'mahasiswa?m=pengajuan'),
('101', 'admin', 'A1317003', 'Surat sudah ditandatangani, siap untuk dikirimkan', '0', '2020-01-02 22:09:19', X'73757261742073696170', 'magang?m=pengajuan'),
('102', 'A1317003', 'admin', 'Adela Valiandra (A1317003) telah mengirim bukti penerimaan magang', '1', '2020-01-06 14:49:20', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('103', 'A1317003', 'admin', 'Agi Munawa (A1317004) telah ditolak oleh perusahaan yang bersangkutan', '1', '2020-01-06 14:49:20', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('104', 'A1317003', 'admin', 'Adela Valiandra (A1317003) telah mengirim bukti penerimaan magang', '1', '2020-01-06 14:49:20', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('105', 'A1317003', 'admin', 'Agi Munawa (A1317004) telah mengirim bukti penerimaan magang', '1', '2020-01-06 14:49:20', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('106', 'A1317003', 'admin', 'Adela Valiandra (A1317003) telah ditolak oleh perusahaan yang bersangkutan', '1', '2020-01-06 14:49:20', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('107', 'A1317003', 'admin', 'Agi Munawa (A1317004) telah mengirim bukti penerimaan magang', '1', '2020-01-06 14:49:20', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('108', 'A1317003', 'admin', 'Adela Valiandra (A1317003) telah mengirim bukti penerimaan magang', '1', '2020-01-06 14:49:20', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('109', 'A1317003', 'admin', 'Agi Munawa (A1317004) telah ditolak oleh perusahaan yang bersangkutan', '1', '2020-01-06 14:49:20', X'62756b7469206469746572696d61', 'mahasiswa?m=pengajuan'),
('110', 'A1317004', 'admin', 'Agi Munawa (A1317004) mengajukan permohonan magang', '1', '2020-01-06 14:49:20', X'70656e67616a75616e206d6167616e67', 'mahasiswa?m=pengajuan');

INSERT INTO `tb_pegawai` (`nip_nik`, `username`, `status`, `nama_pegawai`, `alamat_pegawai`, `jk_pegawai`, `email_pegawai`, `tempat_lahir_pegawai`, `tanggal_lahir_pegawai`, `no_hp_pegawai`, `id_jabatan`, `id_golongan`) VALUES ('090801007', 'marlia@politala.ac.id', NULL, 'Marlia Adriana, M.T.', 'Jl.Almanar No. 23 A Rt.22 Rw.06 Kelurahan Angsau Pelaihari Kab.Tanah Laut', 'Perempuan', 'marlia@politala.ac.id', 'Bati-bati', '1982-03-23', '-', NULL, NULL),
...
('100', NULL, NULL, NULL, NULL, NULL, 'PST001', 'uncheck', 'PT. PLN (persero) Unit Induk Wilayah Kalimantan Selatan & Kalimantan Tengah', 'Jl. Panglima Batur no. 1, Loktabat Utara, Kec. Banjarbaru Utara, Kota Banjarbaru, Kalimantan Selatan', '0511772520', '-3.4384413', '114.825709', '0'),
('101', NULL, NULL, NULL, NULL, NULL, 'PST003', 'uncheck', 'PT. Mitra Megah Profitamas', 'Jl.  Jend.  A.  Yani KM 5,5 No. 1', '0511 325 3355', '', '', '0'),
('102', NULL, NULL, NULL, NULL, NULL, 'PST001', 'uncheck', 'PT. JHONLIN GROUP', 'Gn.Antasari, Simpang Empat, Kabupaten Tanah Bumbu, Kalimantan Selatan 72211', '+6281367365549', '', '', '0');

INSERT INTO `tb_perusahaan_sementara` (`id_perusahaan_sementara`, `nim`, `id_perusahaan`, `status`, `tanggal_pengajuan`, `bukti_diterima`, `tanggal_konfirmasi`, `nomor_surat`) VALUES ('36', 'A1317002', '52', X'746572696d61', '2020-01-02 20:19:47', '/Users/random/htdocs/simpkl/file_upload/bukti/Jurnal_PKL_Danar_Widi_Utomo.pdf', '2020-01-02 09:54:42', 'B/0/PL40/PK.01.06/2020'),
('37', 'A1317001', '53', X'6b6972696d', '2020-01-02 21:42:43', NULL, '2020-01-02 18:47:26', 'B/1/PL40/PK.01.06/2020'),
('38', 'A1317003', '54', X'746f6c616b', '2020-01-02 21:54:01', NULL, '2020-01-02 19:52:46', 'B/2/PL40/PK.01.06/2020'),
('39', 'A1317003', '55', X'746572696d61', '2020-01-10 09:54:44', NULL, '2020-01-02 22:06:12', 'B/3/PL40/PK.01.06/2020'),
('40', 'A1317004', '55', X'746572696d61', '2020-01-10 09:54:44', NULL, '2020-01-02 22:06:12', 'B/3/PL40/PK.01.06/2020'),
('41', 'A1317004', '54', X'70726f736573', '2020-01-02 23:40:05', NULL, '2020-01-02 23:40:05', NULL);

INSERT INTO `tb_program_studi` (`id_program_studi`, `nama_program_studi`, `alias`) VALUES ('PST001', 'Teknik Informatika', NULL),
...
INSERT INTO `tb_seminar_penguji` (`id`, `id_dosen`, `status`) VALUES ('263', '63', 'p1'),
('264', '63', 'p2'),
('265', '64', 'p1'),
('266', '64', 'p2');

INSERT INTO `tb_seminar_tempat` (`id`, `nama`) VALUES ('8', 'Bootstrap'),
('9', 'Mysql');
