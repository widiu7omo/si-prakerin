...
-- Generation Time: 2019-11-22 12:24:40.4470
-- -------------------------------------------------------------
...
CREATE TABLE `tb_jenis_kuisioner` (
  ...
  `key_api_kuisioner` mediumtext DEFAULT NULL,
  `url_kuisioner` mediumtext DEFAULT NULL,
...
CREATE TABLE `tb_kelengkapan` (
  ...
  `urlsourcecode` mediumtext DEFAULT NULL,
  `poster` mediumtext DEFAULT NULL,
  `lembar_pengesahan` mediumtext DEFAULT NULL,
...
INSERT INTO `tb_dosen_bimbingan_mhs` (`id_dosen_bimbingan_mhs`, `id_tahun_akademik`, `id_mhs_pilih_perusahaan`, `nim`, `nip_nik`, `judul_laporan_mhs`) VALUES ('26', 'TA002', '3', 'A1317037', '09081015', NULL),
...
('210', 'TA002', '2', 'A1317025', '14020983', NULL),
('212', 'TA002', '20', 'A1317012', '14020983', 'Sistem informasi manajemen PKL'),
('214', 'TA002', '11', 'A1317002', '14020983', 'Sistem Informasi Manajemen Praktik Kerja Industri');
...
INSERT INTO `tb_konsultasi_bimbingan_offline` (`id`, `id_dosen_bimbingan_mhs`, `lembar_konsultasi`, `tanggal`) VALUES ('11', '212', '9e460feb82d35e74cf28563fd17b6406.pdf', NULL);
